...
test("shared tab component owns character and Mask tab states without geometry", async () => {
  ...
  assert.match(component, /\.character-sheet__workspace > nav\.tabs \{[\s\S]*?border-left: 1px solid var\(--bw-rule\)[\s\S]*?border-right: 1px solid var\(--bw-rule\)/);
